 ...
 * @author sreer
 */
public class SupplierMenuJFrame extends javax.swing.JPanel {

    /**
     * Creates new form SupplierMenuJFrame
     */
    Business business;
    JPanel cardSeqJPanel;
    public SupplierMenuJFrame(JPanel cardSeqJPanel,Business business) throws IOException {
        initComponents();
    ...
    private void manageProductjButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageProductjButtonActionPerformed
        ManageProductsJPanel mp = new ManageProductsJPanel(UserProcessJPanel, business);
                        UserProcessJPanel.add("ManageProductsJPanel ", mp);
                        CardLayout layout = (CardLayout) UserProcessJPanel.getLayout();
                        layout.next(UserProcessJPanel);
